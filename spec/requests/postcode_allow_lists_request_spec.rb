  ...
  describe 'POST /create' do
    context 'with valid parameters' do
      it 'creates new postcode' do
        expect do
          post postcode_allow_lists_url, params: { postcode_allow_lists: valid_attributes }
    ...
    describe 'DELETE /destroy' do
      ...
      #     postcode_allow_list = PostcodeAllowList.create!(valid_attributes)
      #     expect do
      #       delete postcode_allow_list_url, params: { postcode_allow_lists: { id: postcode_allow_list.id + 1 } }
    ...
    context 'with invalid parameters' do
      it 'does not create a new postcode' do
        expect do
          post postcode_allow_lists_url, params: { postcode_allow_lists: invalid_attributes }
        end.to change(PostcodeAllowList, :count).by(0)
      end
