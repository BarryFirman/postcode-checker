  ...
  describe 'routing' do
    context 'used routes' do
      ...
      it 'routes to #edit' do
        expect(get: 'postcode_allow_lists/1/edit').to route_to('postcode_allow_lists#edit', id: '1')
      end
      ...
      it 'routes to #update - put' do
        expect(put: 'postcode_allow_lists/1').to route_to('postcode_allow_lists#update', id: '1')
      end

      it 'routes to  #update - patch' do
        expect(patch: 'postcode_allow_lists/1').to route_to('postcode_allow_lists#update', id: '1')
      end
    end
